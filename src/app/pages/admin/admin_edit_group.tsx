      ...
      <SlideBarContextProvider>
        <main className="min-h-screen bg-[#f8f9fa]">
          ...
          <div className="flex flex-col items-center justify-center h-64 gap-3 mt-16">
            ...
            <button onClick={() => navigate(-1)} className="text-[#c81925] text-sm font-semibold hover:underline">
              Voltar
            </button>
          </div>
        </main>
        ...
        <div className="max-w-4xl mt-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-8 py-2.5 rounded-xl text-sm font-semibold transition-all active:scale-95 disabled:opacity-60 ${
                saveSuccess
                  ? "bg-green-500 text-white"
                  : "bg-[#c81925] text-white hover:bg-red-700"
              }`}
            >
              {saveSuccess ? (
                <><FiCheck className="w-4 h-4" /> Salvo!</>
              ) : isSaving ? (
                "Salvando..."
              ) : (
                "Salvar Alterações"

            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-6">
                ...
                <button 
                  ...
                  className="md:hidden flex items-center justify-center gap-2 border-2 border-gray-300 text-gray-700 bg-white hover:bg-gray-50 px-5 py-2.5 rounded-lg font-medium transition-colors w-full"
                >

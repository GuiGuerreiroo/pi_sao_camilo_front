      ...
      <main className="min-h-screen bg-gray-50 pb-24 font-sans text-gray-800">
        ...
        <div className="px-6 pt-8 pb-4 max-w-lg mx-auto">
          ...
          <div className="flex items-center mb-8 px-2 w-full">
            {[1, 2, 3].map((step, i) => (
              <React.Fragment key={step}>
                <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center font-bold text-sm shrink-0 transition-colors ${step <= currentStep
          ...
          <div className="space-y-6">
            ...
            <div id="field-weight">
              <Input
                label="Massa Corporal Pré-Exercício"
                type="number"
                  ...
                  <div className="flex flex-col">
                    {geoError || weatherError ? (
                      <input
                        ...
                        className="w-25 h-8 bg-gray-200 rounded px-2 py-1 text-sm outline-none focus:ring-1 focus:ring-gray-400 transition-all [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        placeholder="°C"
                      />
                    ) : (
                  ...
                  <div className="flex flex-col items-end">
                    {geoError || weatherError ? (
                      <select
                        ...
                        className="w-25 h-8 bg-gray-200 rounded px-2 py-1 text-sm outline-none focus:ring-1 focus:ring-gray-400 transition-all text-right"
                      >
                        <option>Nula</option>
                        <option>Baixa</option>
                  ...
                  <div className="flex flex-col items-end">
                    {geoError || weatherError ? (
                      <input
                        ...
                        className="w-25 h-8 bg-gray-200 rounded px-2 py-1 text-sm outline-none focus:ring-1 focus:ring-gray-400 transition-all text-right [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        placeholder="km/h"
                      />
                    ) : (
                      <span className="font-bold text-gray-800 text-sm">
